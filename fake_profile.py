import random
fname = ['Rajashree', 'Sandhya', 'Sneha', 'Amrita', 'Dave', 'Kurt', 'Neil', 'Sam', 'Steve', 'Tom', 'James', 'Robert', 'Michael', 'Charles', 'Joe', 'Mary', 'Maggie', 'Nicole', 'Patricia', 'Linda', 'Barbara', 'Elizabeth', 'Laura', 'Jennifer', 'Maria','Adam','Sturt','Nikolson','Tom','Harry','Ruskin','Thor','Rocky','Ravid','David','Harris','Eion','Elon','Mark','Will','Chris']
...
street_names = ['Main', 'High', 'dumdum', 'Mission', 'Nehrue', 'park', 'Pine', 'Cedar', 'Elm', 'Washington', 'Lake', 'Hill']
